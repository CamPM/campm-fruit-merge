        ...
        <section>
          ...
          <ul className="space-y-6">
            <li className="flex gap-4 items-start">
              ...
              <div>
                <p className="text-white font-bold text-sm uppercase">Bomb ($200)</p>
            ...
            <li className="flex gap-4 items-start">
              <span className="text-3xl bg-zinc-900 p-2 rounded-xl">🧹</span>
              <div>
                <p className="text-white font-bold text-sm uppercase">Broom ($500)</p>
            ...
            <li className="flex gap-4 items-start">
              <span className="text-3xl bg-zinc-900 p-2 rounded-xl">✨</span>
              <div>
                <p className="text-white font-bold text-sm uppercase">Sparkle ($1000)</p>
